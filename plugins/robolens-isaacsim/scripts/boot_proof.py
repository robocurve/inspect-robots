"""Boot-only proof: launch Isaac Sim via the RoboInspect adapter on the real install.

Run with the venv that has isaacsim/isaaclab, and RoboInspect + this package on the
...
from roboinspect import Embodiment
...
def main() -> int:
    ...
    # Sanity: the adapter is a valid RoboInspect Embodiment and its info is readable
